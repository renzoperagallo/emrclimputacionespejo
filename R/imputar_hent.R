#' Imputación de la Variable "hent" basada en Datos del Periodo Anterior
#'
#' @description
...
#'
#' @return Devuelve el DataFrame original con la columna he imputada según los criterios establecidos.
#'
#' @export
#'
#' @examples
    ...
    microdato_imputado <-
      ...
      dplyr::mutate(
        valor_t = dplyr::case_when(
          variable == "hent" & nt == 0 ~ 0,
          variable == "hent" & is.na(valor_t) ~ valor_t1,
          .default = valor_t
        )
      )
